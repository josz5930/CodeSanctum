...
const outDir = path.join(repoRoot, "node_modules", ".cache", "evidence-store-test-dist");
...
export async function compileWorkspace() {
  ...
  execFileSync(process.execPath, [
    ...
    outDir,
    "--tsBuildInfoFile",
    path.join(outDir, "evidence-store-test.tsbuildinfo")
  ], {
    cwd: workspacePath,
    stdio: "pipe"
  });
...
export async function importCompiled(relativePath) {
  ...
  return import(pathToFileURL(path.join(dir, "packages", "evidence-store", relativePath)).href);
}
