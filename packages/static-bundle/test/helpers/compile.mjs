...
const outDir = path.join(repoRoot, "node_modules", ".cache", "static-bundle-test-dist");
...
export async function compileWorkspace() {
  ...
  execFileSync(process.execPath, [
    ...
    outDir,
    "--tsBuildInfoFile",
    path.join(outDir, "static-bundle-test.tsbuildinfo")
  ], {
    cwd: workspacePath,
    stdio: "pipe"
  });
...
export async function importCompiled(relativePath) {
  ...
  return import(pathToFileURL(path.join(dir, "packages", "static-bundle", relativePath)).href);
}
